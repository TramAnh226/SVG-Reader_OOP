...
// void SVGParser::parsePath(SVGPath* path, tinyxml2::XMLElement* xmlNode) {
//     const char* dAttr = xmlNode->Attribute("d");
//     if (!dAttr) return;
//
//     std::string d = dAttr;
//     size_t pos = 0;
...
//                 PathCommandType prevType = path->commands.back().type;
