...
//     Gdiplus::Pen pen(rect->getStrokeColor(), rect->getStrokeWidth());
...
//     Gpiplus::PointF center = ellipse->getCenter();// trong CustomPoint có thể viết thêm chuyển đổi CustomPoint thành PointF
//     float rx = ellipse->getRadiusX();
//     float ry = ellipse->getRadiusY();

//     Gdiplus::SolidBrush brush(ellipse->getFillColor());
//     Gdiplus::Pen pen(ellipse->getStrokeColor(), ellipse->getStrokeWidth());
...
//     Gdiplus::Pen pen(line->getStrokeColor(), line->getStrokeWidth());// trong SVGLine viết thêm getStrokeLine(), getStrokeColor
...
//     Gdiplus::SolidBrush brush(polygon->getFillColor()); //trong SVGLine viết thêm getFillColor(), 
//     Gdiplus::Pen pen(polygon->getStrokeColor(), polygon->getStrokeWidth());// getStrokeColor(), getStrokeWidth()
...
//     Gdiplus::Pen pen(polyline->getStrokeColor(), polyline->getStrokeWidth());// tương tự 
...
//     Gdiplus::SolidBrush brush(square->getFillColor());
//     Gdiplus::Pen pen(square->getStrokeColor(), square->getStrokeWidth());
